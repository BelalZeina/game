                        ...
                        <tbody>
                            ...
                            @foreach ($data as $user)
                                <tr>
                                    ...
                                    <td> {{ $user->phone }}</td>
                                    <td><img src="{{ image_url($user->img) }}" alt=""
                                    ...
                                    <td>
                                        ...
                                        @else
                                            <div class="btn btn-icon btn-info"><i class="fa-solid fa-power-off"
                                                    style="color:#fff"></i></div>
                                        @endif
                                    </td>
                                    <td>
                                        ...
                                        <div class="dropdown">
                                            ...
                                            <div class="dropdown-menu">
                                                ...
                                                <a class="dropdown-item cursor-pointer" data-bs-toggle="modal"
                                                    data-bs-target="#{{ "modalToggleActive-$user->id" }}"><i
                                                        class="fa fa-power-off me-1"></i>
                                                    {{ __('models.active') }}</a>

                                                <a class="dropdown-item cursor-pointer" data-bs-toggle="modal"
                                                    data-bs-target="#{{ "modalToggle-$user->id" }}"><i
