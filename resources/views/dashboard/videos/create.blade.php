...
@section('header__title', __('models.video'))
@section('main')
        ...
        <div class="container-xxl flex-grow-1 container-p-y">
            ...
            <div class="card">
                <div class="d-flex p-3 px-4 align-items-center justify-content-between w-100">
                    <h5 class="card-header p-0">{{ __('models.add_video') }}</h5>
                ...
                <div class="card-body">
                    ...
                    <form class="row g-3 needs-validation" method="POST" action="{{ route('videos.store') }}"
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" class="form-control  @error('desc_ar') is-invalid @enderror" name="desc_ar" value="{{ old('desc_ar') }}"
                                id="desc_ar" required>
                            @error('desc_ar')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" class="form-control  @error('desc_en') is-invalid @enderror" name="desc_en" value="{{ old('desc_en') }}"
                                id="desc_en" required>
                            @error('desc_en')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
