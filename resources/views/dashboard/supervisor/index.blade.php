                ...
                <div class="d-flex align-item-center p-4 justify-content-between w-100">
                    ...
                    <div class="d-flex align-item-center gap-3">
                        <div class="d-felx d-xl-block mr-1"><!-- Hide on small screens -->
                            ...
                            <a class="btn btn-success" href="{{ route('supervisors.export') }}" title="{{__("models.export")}}"><i class="fa-solid fa-file-export"></i></a>
                            <a class="btn btn-success cursor-pointer" data-bs-toggle="modal" title="{{ __('models.import') }}"
                            data-bs-target='#modalToggle'><i class="fa-solid fa-file-import"></i></a>
                        </div>
                        @include('components.modalImport', [
                            'action' => 'supervisors.import',
